...
- Connect to Visual Studio Code from the Workshop launch page (provided by your instructor).  The password is provided below the WebUI link.
  ...
  ![launch page](AAP/launch_page.png)

- Type in the provided password to connect.

  ![login vs code](AAP/vscode_login.png)
...
- Open a terminal in Visual Studio Code:
  ...
  ![picture of new terminal](AAP/vscode-new-terminal.png)
...
![ansible-navigator images](AAP/navigator-images.png)
...
![ee main menu](AAP/navigator-ee-menu.png)
...
![ee info](AAP/navigator-ee-collections.png)
