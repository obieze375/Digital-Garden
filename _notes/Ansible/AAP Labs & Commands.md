...
Structure wise to create your're own home lab install Controller, Automartion Hub, and the Database on it's own server. So you have to provision 3 servers and chain them together via SSH, make sure to chmod the ssh key to 600. Also doublecheck for different types of OS and envs (i.e AWS). Use the  most stable version of RHEL! Not the newest. Going forward wait 6 months before using a new OS
...
![](ansible-navigator-doc-techbealy.png)
...
![](ansible-navigator-images-techbealy.png)
...
![](ansible-navigator-collections-techbealy.png)
...
![](ansible-navigator-run-1024x446.png)
